...
<main>
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="mt-4">Students Lists</h1>
        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="GET" action="{{url('/student/search')}}">
            <div class="input-group">
                <input class="form-control mb-4" type="text" name="search_name" placeholder="Search by name..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
